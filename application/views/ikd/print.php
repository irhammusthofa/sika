        ...
        <table width="100%" style="border-collapse: collapse;">
            <tr>
                            ...
                            <td style="font-size:9pt;border-bottom:1px solid black;padding:2px;vertical-align: top">Lampiran : <br>
                                <table width="100%">
                                    <tr>
                                        ...
                                        <td width="10px"><div class="circleBase" style="margin-left:5px;border:1px solid black;width:10px;height:10px"></div></td>   
                                        <td style="font-size:9pt;">JHSEA/HIRA</td>
                                    </tr>
                                    <tr>
                            ...
                            <td colspan="2" style="vertical-align: top;">
                                <table width="100.4%" style="border-collapse: collapse;margin-top:-1px;margin-left:-1px">
                                    <tr>
                                        ...
                                        <table width="100%">
                                            <tr>
                                                <td width="10px" ><i style="margin-left:5px;" class="fa fa-<?= (array_search("Gas Lemas",$bahaya)!==false) ? 'check-' : '' ?>square-o"></i> <span style="font-size:9pt;">Gas Lemas,</span></td>
                                            ...
                                            <tr>
                                                <td width="10px" ><i style="margin-left:5px;" class="fa fa-<?= (array_search("Kekurangan Oksigen",$bahaya)!==false) ? 'check-' : '' ?>square-o"></i> <span style="font-size:9pt;">Kekurangan Oksigen</span></td>
                                            ...
                                            <tr>
                                                <td width="10px" ><i style="margin-left:5px;" class="fa fa-<?= (array_search("Mesin bergerak/berputar",$bahaya)!==false) ? 'check-' : '' ?>square-o"></i> <span style="font-size:9pt;">Mesin bergerak/berputar</span></td>
                                                ...
                                                <td width="10px" ><i style="margin-left:5px;" class="fa fa-<?= (array_search("Dampak visual",$bahaya)!==false) ? 'check-' : '' ?>square-o"></i> <span style="font-size:9pt;">Dampak visual</span></td>
                                                <td width="10px" ><i style="margin-left:5px;" class="fa fa-<?= (array_search("",$bahaya)!==false) ? 'check-' : '' ?>square-o"></i> <span style="font-size:9pt;">____________________</span></td>
                                            </tr>
                                        </table>
                                        </td>
                                    </tr>
                ...
                <td width="230px"  style="border-top:1px solid black;vertical-align: top">
                    <div style="background-color:#64caef;text-align:center;vertical-align: center;padding:10px;font-size:9pt">IZIN KERJA DINGIN (IKD)</div>
    ...
    <tr>
        <table width="100%" style="border-collapse:collapse">
            ...
            <tr>
                ...
                <td style="padding:2px;vertical-align: top">
                &nbsp;<i class="fa fa-<?= (array_search("Pengetesan gas sebelum mulai kerja (LEL, O2, Toxic)",$pengendalian)!==false)  ? 'check-' : '' ?>square-o"></i> &nbsp;<i class="fa fa-circle-o"></i> &nbsp; <span style="font-size:9pt">Pengetesan gas sebelum mulai kerja (LEL, O2, Toxic)</span>
                </td>
                <td style="padding:2px;vertical-align: top">
                &nbsp;<i class="fa fa-<?= (array_search("Tirai pelindung semprotan pasir",$pengendalian)!==false)  ? 'check-' : '' ?>square-o"></i> &nbsp;<i class="fa fa-circle-o"></i> &nbsp; <span style="font-size:9pt">Tirai pelindung semprotan pasir</span>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="padding:2px;vertical-align: top">
                &nbsp;<i class="fa fa-<?= (array_search("Alat anti percikan api (Non sparking Tools)",$pengendalian)!==false)  ? 'check-' : '' ?>square-o"></i> &nbsp;<i class="fa fa-circle-o"></i> &nbsp; <span style="font-size:9pt">Alat anti percikan api (Non sparking Tools)</span>
                </td>
                <td style="padding:2px;vertical-align: top">
            ...
            <tr>
                ...
                <td style="padding:2px;vertical-align: top">
                &nbsp;<i class="fa fa-<?= (array_search("Peralatan tanpa tekanan",$pengendalian)!==false)  ? 'check-' : '' ?>square-o"></i> &nbsp;<i class="fa fa-circle-o"></i> &nbsp; <span style="font-size:9pt">Peralatan tanpa tekanan</span>
                </td>
                <td style="padding:2px;vertical-align: top">
                &nbsp;<i class="fa fa-<?= (array_search("Tambahan lampu penerangan",$pengendalian)!==false)  ? 'check-' : '' ?>square-o"></i> &nbsp;<i class="fa fa-circle-o"></i> &nbsp; <span style="font-size:9pt">Tambahan lampu penerangan</span>
                </td>
            </tr>
            <tr>
                ...
                <td style="padding:2px;vertical-align: top">
                &nbsp;<i class="fa fa-<?= (array_search("Peralatan dikuras(flushing)",$pengendalian)!==false)  ? 'check-' : '' ?>square-o"></i> &nbsp;<i class="fa fa-circle-o"></i> &nbsp; <span style="font-size:9pt">Pengetesan gas sebelum mulai</span>
                </td>
                <td style="padding:2px;vertical-align: top">
                &nbsp;<i class="fa fa-<?= (array_search("Scaffolding/perancah/tangga",$pengendalian)!==false)  ? 'check-' : '' ?>square-o"></i> &nbsp;<i class="fa fa-circle-o"></i> &nbsp; <span style="font-size:9pt">Scaffolding/perancah/tangga</span>
                </td>
            </tr>
            <tr>
                ...
                <td style="padding:2px;vertical-align: top">
                &nbsp;<i class="fa fa-<?= (array_search("Pos Pemeriksaan (barang dan data pribadi) ",$pengendalian)!==false)  ? 'check-' : '' ?>square-o"></i> &nbsp;<i class="fa fa-circle-o"></i> &nbsp; <span style="font-size:9pt">Pos Pemeriksaan (barang dan data pribadi) </span>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="padding:2px;vertical-align: top">
                &nbsp;<i class="fa fa-<?= (array_search("PPE sand blasting",$pengendalian)!==false)  ? 'check-' : '' ?>square-o"></i> &nbsp;<i class="fa fa-circle-o"></i> &nbsp; <span style="font-size:9pt">PPE sand blasting</span>
                </td>
                <td style="padding:2px;vertical-align: top">
                &nbsp;<i class="fa fa-<?= (array_search("",$pengendalian)!==false)  ? 'check-' : '' ?>square-o"></i> &nbsp;<i class="fa fa-circle-o"></i> &nbsp; <span style="font-size:9pt"></span>
                </td>
            </tr>
            <tr>
