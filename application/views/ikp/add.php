          		...
          		<div class="row clearfix">
					...
					<div class="col-md-10">
						...
						<div class="form-group">
							...
							<br><input type="checkbox" name="lampiran[]" value="HIRA"> HIRA &nbsp;
						</div>
					</div>
					<div class="col-lg-12">
						<label for="identiikasi_bahaya" class="control-label">Identifikasi Bahaya</label>
						<div class="form-group">
						<input type="checkbox" name="identiikasi_bahaya[]" value="Nyala api, percikan api"> Nyala api, percikan api &nbsp;
						<br><input type="checkbox" name="identiikasi_bahaya[]" value="Bahan mudah terbakar"> Bahan mudah terbakar &nbsp;
						...
						<br><input type="checkbox" name="identiikasi_bahaya[]" value="Ledakan"> Ledakan &nbsp;
						...
						<br><input type="checkbox" name="identiikasi_bahaya[]" value="Kebersihan Makanan"> Kebersihan Makanan &nbsp;	
						...
						<br><input type="checkbox" name="identiikasi_bahaya[]" value="Mesin-mesin yang bergerak/berputar"> Mesin-mesin yang bergerak/berputar &nbsp;	
					...
					<div class="col-lg-12">
						...
						<br><input type="checkbox" name="pengendalian_bahaya[]" value="Peralatan Dikosongkan/dibersihkan/difhusing"> Peralatan Dikosongkan/dibersihkan/difhusing &nbsp;
						<br><input type="checkbox" name="pengendalian_bahaya[]" value="Lapisan penahan percikan las"> Lapisan penahan percikan las &nbsp;
						<br><input type="checkbox" name="pengendalian_bahaya[]" value="Tirai Pelindung Pengelasan"> Tirai Pelindung Pengelasan &nbsp;	
						<br><input type="checkbox" name="pengendalian_bahaya[]" value="Tirai Air"> Tirai Air &nbsp;
						<br><input type="checkbox" name="pengendalian_bahaya[]" value="Area Kerja Selalu Dibasahi"> Area Kerja Selalu Dibasahi &nbsp;	
						...
						<br><input type="checkbox" name="pengendalian_bahaya[]" value="Pengetesan Gas Sebelum mulai"> Pengetesan Gas Sebelum mulai &nbsp;	
						<br><input type="checkbox" name="pengendalian_bahaya[]" value="Tempat Kerja di-ventilasi"> Tempat Kerja di-ventilasi &nbsp;
						<br><input type="checkbox" name="pengendalian_bahaya[]" value="Peralatan disolasi/dilepas"> Peralatan disolasi/dilepas &nbsp;
						<br><input type="checkbox" name="pengendalian_bahaya[]" value="Sekering dicabut/dimatikan dan dipasang LOTO"> Sekering dicabut/dimatikan dan dipasang LOTO &nbsp;	
						...
						<br><input type="checkbox" name="pengendalian_bahaya[]" value="Alat Pemadam Api Ringan (APAR)"> Alat Pemadam Api Ringan (APAR) &nbsp;
						...
						<br><input type="checkbox" name="pengendalian_bahaya[]" value="Tanda Keseleamatan"> Tanda Keseleamatan &nbsp;
						<br><input type="checkbox" name="pengendalian_bahaya[]" value="Peralatan di-purging dengan N2"> Peralatan di-purging dengan N2 &nbsp;	
						<br><input type="checkbox" name="pengendalian_bahaya[]" value="Dipassang Scaffolding/perancah/tanggah"> Dipassang Scaffolding/perancah/tanggah &nbsp;
						<br><input type="checkbox" name="pengendalian_bahaya[]" value="Dibebaskan dari tekanan"> Dibebaskan dari tekanan &nbsp;
						<br><input type="checkbox" name="pengendalian_bahaya[]" value="Didinginkan Secara Mekanis"> Didinginkan Secara Mekanis &nbsp;	
						<br><input type="checkbox" name="pengendalian_bahaya[]" value="Bebas dari endapan yg explosive/toxic"> Bebas dari endapan yg explosive/toxic &nbsp;	
						<br><input type="checkbox" name="pengendalian_bahaya[]" value="Semua sewer dalam jarak 15 m ditutup"> Semua sewer dalam jarak 15 m ditutup &nbsp;
						<br><input type="checkbox" name="pengendalian_bahaya[]" value="Fire Blanket"> Fire Blanket &nbsp;
						<br><input type="checkbox" name="pengendalian_bahaya[]" value="Non Sparking Tools"> Peralatan di-purging dengan N2 &nbsp;	
						<br><input type="checkbox" name="pengendalian_bahaya[]" value="Disiapkan Jalur Evakuasi"> Disiapkan Jalur Evakuasi &nbsp;
						<br><input type="checkbox" name="pengendalian_bahaya[]" value="Kacamata Las dan Apron"> Kacamata Las dan Apron &nbsp;
